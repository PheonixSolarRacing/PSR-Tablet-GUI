...
public class PDBTab {
	...
	public static void battery_1_voltage(com.artemis.World world, Node n){
		...
		edit2.add(new TextComponent("NA", "battery_1_voltage", (Label) n));
		edit2.add(new TimingComponent(500, TimingType.ASTABLE));
	}
	
	public static void battery_2_voltage(com.artemis.World world, Node n){
		Entity e3 = world.createEntity();
		EntityEdit edit3 = e3.edit();
		edit3.add(new TextComponent("NA", "battery_2_voltage", (Label) n));
